...
{
    {BLE_UUID_OBD_SERVICE, BLE_UUID_TYPE_BLE},
...
static void gap_params_init(void)
{
    ...
    err_code = sd_ble_gap_appearance_set(BLE_APPEARANCE_GENERIC_OUTDOOR_SPORTS_ACT); //TODO: revise the appearance options
    APP_ERROR_CHECK(err_code);
...
static uint32_t ble_new_event_handler(void)
{
    ...
    //TODO UNUSED_VARIABLE(xSemaphoreGiveFromISR(m_ble_event_ready, &yield_req));
